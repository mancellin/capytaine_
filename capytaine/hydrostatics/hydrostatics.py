"""Hydrostatics"""
# Copyright (C) 2025 Matthieu Ancellin
...
class HydrostaticsMixin(ABC):
    """Define methods meant to be inherited by FloatingBody."""
    ...
    def compute_hydrostatic_stiffness(self, *, divergence=None, rho=1000.0, g=9.81):
        ...
        def divergence_dof(influenced_dof):
            if influenced_dof.lower() in {"surge", "sway", "heave", "roll", "pitch", "yaw"}:
